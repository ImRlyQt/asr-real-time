...
class ASRStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Transcribe = channel.stream_stream(
                ...
                response_deserializer=asr__pb2.Transcription.FromString,
...
def add_ASRServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Transcribe': grpc.stream_stream_rpc_method_handler(
                    ...
                    response_serializer=asr__pb2.Transcription.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'ASR', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('ASR', rpc_method_handlers)
...
class ASR(object):
    ...
    def Transcribe(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            asr__pb2.Transcription.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
